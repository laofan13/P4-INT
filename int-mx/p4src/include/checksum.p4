...
control SwitchVerifyChecksum(inout headers hdr, inout local_metadata_t local_metadata) {
    apply {  }
}

control SwitchComputeChecksum(inout headers hdr, inout local_metadata_t local_metadata){
    apply{
        update_checksum(
            hdr.ipv4.isValid(),
            { 
                hdr.ipv4.version,hdr.ipv4.ihl,hdr.ipv4.dscp,hdr.ipv4.ecn,
                hdr.ipv4.len,hdr.ipv4.identification,hdr.ipv4.flags,
        ...
        update_checksum(
            ...
            {
                hdr.report_ipv4.version,hdr.report_ipv4.ihl,hdr.report_ipv4.dscp,
                hdr.report_ipv4.ecn,hdr.report_ipv4.len,hdr.report_ipv4.identification,
